...
scripts/run-ingame.sh         # the engine gate: both packaged examples under a real Factorio via
                              ...
                              # no element of any localised string in either dump is over the
                              # engine's 200-byte ceiling.
