...
- **The packless refusal names the rungs it tried.** `fkrecipes: the technology X has no science pack the game has; research takes at least one` now ends `, and none of <names> is a science pack here`, so a test comparing the whole sentence moves.
