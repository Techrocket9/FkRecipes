...
Fifteen behaviours are the ones a suite is most likely to have pinned. Each is stated as the failure it produces, so a red test can be matched against it:
